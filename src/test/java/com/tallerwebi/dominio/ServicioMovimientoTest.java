...
public class ServicioMovimientoTest {
    ...
    @Test
    public void queAlSolicitarAlServicioActualizarMovimientoLanceExcepcionBaseDeDatos() throws ExcepcionBaseDeDatos, ExcepcionMovimientoNoEncontrado, ExcepcionCamposInvalidos {
        //preparacion
        DatosEditarMovimiento datosEditarMovimiento = mock(DatosEditarMovimiento.class);
        when(datosEditarMovimiento.getId()).thenReturn(1L);
        when(datosEditarMovimiento.getCategoria()).thenReturn("SUPERMERCADO");
    ...
    @Test
    public void queAlSolicitarAlServicioActualizarMovimientoLanceExcepcionCamposInvalidos() throws ExcepcionBaseDeDatos, ExcepcionMovimientoNoEncontrado, ExcepcionCamposInvalidos {
         //preparacion
         DatosEditarMovimiento datosEditarMovimiento = mock(DatosEditarMovimiento.class);
         when(datosEditarMovimiento.getId()).thenReturn(1L);
    ...
    @Test
    public void queAlSolicitarAlServicioNuevoMovimientoLanceExcepcionBaseDeDatos() throws ExcepcionBaseDeDatos, ExcepcionCamposInvalidos {
        //preparacion
        DatosAgregarMovimiento datosAgregarMovimiento = mock(DatosAgregarMovimiento.class);
        when(datosAgregarMovimiento.getDescripcion()).thenReturn("descripcion");
        when(datosAgregarMovimiento.getMonto()).thenReturn(1.0);
    ...
    @Test
    public void queAlSolicitarAlServicioNuevoMovimientoLanceExcepcionCamposInvalidos() throws ExcepcionBaseDeDatos, ExcepcionCamposInvalidos {
        //preparacion
        DatosAgregarMovimiento datosAgregarMovimiento = mock(DatosAgregarMovimiento.class);
