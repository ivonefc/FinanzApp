...
INSERT INTO usuarios(email, password, rol, activo, nombre, apellido, nombreUsuario, fechaNacimiento, pais, telefono) VALUES('test1@unlam.edu.ar', 'test', 'FREE', true, 'CR7', 'Grupo 10', 'grupo', '2024/05/15', 'Argentina', '1122334455');
INSERT INTO usuarios(email, password, rol, activo) VALUES('test2@unlam.edu.ar', 'test', 'FREE', true);
INSERT INTO usuarios(email, password, rol, activo) VALUES('test3@unlam.edu.ar', 'test', 'FREE', true);
