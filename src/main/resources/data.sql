...
INSERT INTO usuarios(email, password, rol, activo, nombre, apellido, nombreUsuario, fechaNacimiento, pais, telefono) VALUES('test1@unlam.edu.ar', 'test', 'ADMIN', true, 'CR7', 'Grupo 10', 'grupo', '2024/05/15', 'Argentina', '1122334455');
